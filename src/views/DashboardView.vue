        ...
        <div class="card">
          ...
          <div class="quick-actions">
            ...
            <div class="actions-grid">
              ...
              <router-link v-if="authStore.isTrainer" to="/trainer/templates" class="action-card">
                ...
                <div class="action-content">
                  <p class="action-title">Mis Rutinas</p>
                  <p class="action-description">Crear y gestionar plantillas</p>
                </div>
              </router-link>

              <router-link v-if="authStore.isTrainer" to="/trainer/students" class="action-card">
                ...
                <div class="action-content">
                  <p class="action-title">Mis Estudiantes</p>
                  <p class="action-description">Gestionar y asignar rutinas</p>
                </div>
              </router-link>
